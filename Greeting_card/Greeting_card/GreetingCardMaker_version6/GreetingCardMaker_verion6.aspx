<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GreetingCardMaker_verion6.aspx.cs" Inherits="Greeting_card.GreetingCardMaker_version6.GreetingCardMaker_verion6" %>
...
<asp:Button ID="cmdUpdate"  runat="server" Width="71px" Height="24px" Text="Update" PostBackUrl="~/GreetingCardMaker_version6/greetingcard.aspx" />
</div>
</form>
</body>
</html>