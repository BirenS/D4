<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GreetingCard1.aspx.cs" Inherits="WebApplication1.CE_136_Chinmay_Vadgama.GreetingCard1" %>
...
<body>
   ...
   <asp:DropDownList ID="lstFontName" runat="server" Width="194px" Height="22px" /><br /><br />
    ...
    <asp:Button ID="cmdUpdate" OnClick="cmdUpdate_Click" runat="server" Width="71px" Height="24px" Text="Update" />              
         ...
         <asp:Image ID="imgDefault" runat="server" Width="212px"  Height="212px" />   
