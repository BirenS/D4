...
namespace WebApplication1.A.chinmay_solanki_CE127_greetingcardapplications.GreetingCardMaker_version7
{
    public partial class GreetingCardMaker_version7 : System.Web.UI.Page
    {
        ...
        protected void cmdUpdate_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/A.chinmay_solanki_CE127_greetingcardapplications/GreetingCardMaker_version7/Greeting_card.aspx?val1="+s1+"&val2="+s2+"&val3="+s3+"&val4="+s4+"&val5="+s5+"&val6="+s6);
        }
    }
}